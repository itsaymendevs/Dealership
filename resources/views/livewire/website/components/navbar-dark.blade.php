    ...
    <div class="container-fluid px-0">
        <div class="collapse navbar-collapse navbar--collapse" id="navcol-1">
            <div class="d-flex align-items-center flex-column h-100 justify-content-evenly">
                ...
                {{-- 1: Home --}}
                <a wire:navigate class="btn btn--navbar scale--4 mobile" href="{{ route('website.home') }}">
        ...
        {{-- MobileNavbar --}}
        <section id="navbar--section" class="navbar--section alternative">
                ...
                <div class="row g-0 align-items-center pulse animated h-100 w-100" style="width: 100% !important">
                    ...
                    <div class="col-12 col-xl-8 d-none d-md-block">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            {{-- home --}}
                            <a wire:navigate class="btn btn--navbar scale--4" href="{{ route('website.home')}}"><svg
                            ...
                            {{-- outStock --}}
                            <a wire:navigate
                                class="btn btn--navbar scale--4 {{ Request::is('stock') || Request::is('stock/*') ? 'active' : '' }}"
                                href="{{ route('website.stock')}}"><svg xmlns="http://www.w3.org/2000/svg" width="1em"
                                ...
                                </svg><span class="{{ Request::is('stock') || Request::is('stock/*') ? 'fs-5' : ''
                                    }}">Our Stock</span></a>
                            ...
                            {{-- sellVehicle --}}
                            <button
                                class="btn btn--navbar scale--4 {{ Request::is('sell-vehicle') || Request::is('sell-vehicle/*') ? 'active' : '' }}"
                                type="button">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                                    viewBox="0 0 16 16" class="bi bi-chevron-double-right">
                                    <path fill-rule="evenodd"
                                    ...
                                    class="{{ Request::is('sell-vehicle') || Request::is('sell-vehicle/*') ? 'fs-5' : ''}}">Sell
                                    Vehicle</span></button>
                            ...
                            {{-- aboutUs --}}
                            <a wire:navigate
                                class="btn btn--navbar scale--4 {{ Request::is('about') || Request::is('about/*') ? 'active' : '' }}"
                                href="{{ route('website.about') }}"><svg xmlns="http://www.w3.org/2000/svg" width="1em"
                                    height="1em" fill="currentColor" viewBox="0 0 16 16"
                                    class="bi bi-chevron-double-right">
                                    <path fill-rule="evenodd"
                                        d="M3.646 1.646a.5.5 0 0 1 .708 0l6 6a.5.5 0 0 1 0 .708l-6 6a.5.5 0 0 1-.708-.708L9.293 8 3.646 2.354a.5.5 0 0 1 0-.708z">
                                ...
                                </svg><span class="{{ Request::is('about') || Request::is('about/*') ? 'fs-5' : ''
                                    }}">About Us</span></a>
                            ...
                            {{-- reachUs --}}
                            <button
                                class="btn btn--navbar scale--4 {{ Request::is('reach-us') || Request::is('reach-us/*') ? 'active' : '' }}"
                                type="button">
                                <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor"
                                    viewBox="0 0 16 16" class="bi bi-chevron-double-right">
                                    <path fill-rule="evenodd"
                                ...
                                </svg><span class="{{ Request::is('reach-us') || Request::is('reach-us/*') ? 'fs-5' : ''
                                    }}">Reach Us</span>
                            </button>
                        </div>
